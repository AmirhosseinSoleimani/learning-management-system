...
class FavouriteTeacher extends StatefulWidget {
  static const routeName = '/second_student_favourite';

  const FavouriteTeacher({Key? key}) : super(key: key);

  @override
  State<FavouriteTeacher> createState() => _FavouriteTeacherState();
}

class _FavouriteTeacherState extends State<FavouriteTeacher> {
